...
public class Demo2Activity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ActivityCompat.requestPermissions(Demo2Activity.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.READ_EXTERNAL_STORAGE}, 100);
    }
    ...
    private void showProgressDialog() {
        mHandler.post(new Runnable() {
            ...
            public void run() {
                if (progressDialog == null) {
                    progressDialog = ProgressDialog.show(Demo2Activity.this,
